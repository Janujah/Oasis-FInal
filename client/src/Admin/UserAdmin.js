...
function UserTable() {
    ...
    const fetchUsers = () => {
        fetch('http://oasis-final-directory.onrender.com/SignUp/view')
    ...
    const verifyUser = (id) => {
        fetch(`http://oasis-final-directory.onrender.com/SignUp/verify/${id}`, {
            method: 'PATCH',
    ...
    const deleteUser = (id) => {
        if (window.confirm('Are you sure you want to delete this user?')) {
            fetch(`http://oasis-final-directory.onrender.com/SignUp/delete/${id}`, {
                method: 'DELETE',
            })
                .then(response => {
                    if (!response.ok) {
    ...
    const submitEditForm = () => {
        ...
        fetch(`http://oasis-final-directory.onrender.com/SignUp/update/${editFormData._id}`, {
            method: 'PUT',
            headers: {
